...
public class ChatRoomActivitylab5 extends AppCompatActivity {
    ...
    int numObjects = 6;
    ArrayList<Messagelab5> messages = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText userTyped = (EditText) findViewById(R.id.editChat);
        Button sendButton = (Button) findViewById(R.id.buttonSend);
        Button receiveButton = (Button) findViewById(R.id.buttonReceive);
        ...
        while (results.moveToNext()) {
            ...
            messages.add(new Messagelab5(message, isSent, id));
        }
        ...
        sendButton.setOnClickListener(c -> {
            ...
            this.printCursor();
            userTyped.setText("");
            messages.add(new Messagelab5(userType, true, newId));
        ...
        receiveButton.setOnClickListener(c -> {
            ...
            this.printCursor();
            userTyped.setText("");
            messages.add(new Messagelab5(userType, false, newId));
            adapter.notifyDataSetChanged();
            Snackbar.make(sendButton, "Inserted message id:" + newId, Snackbar.LENGTH_LONG).show();
    ...
    protected class ChatAdapter extends BaseAdapter {
        ...
        public View getView(int position, View old, ViewGroup parent) {
            ...
            View newView;
            if (!isSent) {
                newView = inflater.inflate(R.layout.activity_sending, parent, false);
            } else {
                newView = inflater.inflate(R.layout.activity_receiving, parent, false);
            }
            TextView rowText = (TextView) newView.findViewById(R.id.message_text);
    ...
    protected class MyOwnAdapter extends BaseAdapter {
        ...
        public View getView(int position, View old, ViewGroup parent) {
            ...
            View newView = inflater.inflate(R.layout.activity_message_details, parent, false);
